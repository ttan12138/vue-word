    ...
    $.fn.wordExport = function () {
      ...
      var statics = {
        mhtml: {
          ...
          //         {page:WordSection1;}
          //       </style>\n_styles_\n</head>\n`,
          body: "<!DOCTYPE html><html><head><meta charset='UTF-8'></head>_body_</html>"
        }
      };
      var options = {
        maxWidth: 749
      ...
      // var fileContent = statics.mhtml.top.replace("_html_", statics.mhtml + statics.mhtml.body.replace("_body_", markup.html()));
      var fileContent =  statics.mhtml.body.replace("_body_", markup.html())
      // Create a Blob with the file contents
      var blob = new Blob([fileContent], {
        type: "application/msword;charset=utf-8"
      });
      
      // const docx = htmlDocx.asBlob(fileContent)
      // console.log(docx)
      // return docx
      // // console.log(blob)
